...
<head>
    ...
    <title>Export Data Produk/Obat</title>
</head>
    ...
    <div class="container d-flex justify-content-center align-items-center py-5">
        <div class="card shadow" style="width: 18rem;">
            ...
            <div class="card-body text-center">
                ...
                <a href="../../reports/report-obat.php" class="btn btn-sm bg-secondary w-100 text-white">Back</a>
            </div>
        </div>
    </div>
...
$sheet->setCellValue('I1', 'KETERANGAN');
    ...
    $datas = mysqli_query($koneksi, "SELECT p.id, p.nama_obat, p.kode_obat, p.stock, p.harga, p.keterangan, k.nama_kategori, s.nama_satuan, sup.nama_sup 
    FROM produk as p 
    ...
    while ($data = mysqli_fetch_assoc($datas)) {
        ...
        $sheet->setCellValue('B' . $i, $data['kode_obat']);
        $sheet->setCellValue('C' . $i, $data['nama_obat']);
