...
$pdf->Cell(0,10,'DATA PRODUK / OBAT',0,1,'C');
$pdf->Cell(0,5,'',0,1);
...
$sql = mysqli_query($koneksi,"SELECT p.id, p.nama_obat, p.kode_obat, p.stock, p.harga, p.keterangan, k.nama_kategori, s.nama_satuan, sup.nama_sup 
FROM produk as p 
...
while($d = mysqli_fetch_array($sql)){
  ...
  $pdf->Cell(45,6, $d['nama_obat'],1,0,'C');
