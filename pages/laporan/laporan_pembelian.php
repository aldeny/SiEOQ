...
<head>
    ...
    <title>EOQ - Laporan Pembelian</title>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <form action="" method="GET">
                                ...
                                <a href="laporan_pembelian.php" class="btn btn-sm btn-dark text-white mb-4">Reset</a>
                                <a href="../reports/export-pembelian-excel.php?dari=<?= $dari ?>&sampai=<?= $sampai ?>"
                                    class="btn btn-sm btn-success text-white mb-4"><i class="fas fa-file-excel"></i>
                                    Export Excel</a>
                                <a href="../reports/export-pembelian-pdf.php?dari=<?= $dari ?>&sampai=<?= $sampai ?>"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-info btn-sm" id="btn-detail"
                                                    data-kode="<?= $data['kode_transaksi'] ?>">Detail</a></td>
                                        </tr>
