    ...
    <div class="container d-flex justify-content-center align-items-center py-5">
        <div class="card shadow" style="width: 18rem;">
            ...
            <div class="card-body text-center">
                ...
                <a href="../laporan/laporan_obat.php" class="btn btn-sm bg-secondary w-100 text-white">Back</a>
            </div>
        </div>
    </div>
...
$sheet->setCellValue('I1', 'KETERANGAN');
    ...
    $datas = mysqli_query($conn, "SELECT p.id, p.nama_obat, p.kode_obat, p.stock, p.harga, p.keterangan, k.nama_kategori, s.nama_satuan, sup.nama_sup 
    FROM produk as p 
