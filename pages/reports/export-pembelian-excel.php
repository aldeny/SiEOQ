...
$sheet->setCellValue('K1', 'TANGGAL');
    ...
    if (isset($_GET['dari']) && isset($_GET['sampai'])) {
        ...
        $writer->save('Data Pembelian.xlsx');
        echo "<script>window.location = 'Data Pembelian.xlsx'</script>";
    ...
    $writer = new Xlsx($spreadsheet);
    $writer->save('Data Pembelian all.xlsx');
    echo "<script>window.location = 'Data Pembelian all.xlsx'</script>";
