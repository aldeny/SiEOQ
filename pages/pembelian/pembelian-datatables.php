...
$sql = "SELECT tp.id, tp.kode_transaksi, tp.tanggal, u.nama, tp.keterangan 
...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && $_SERVER['HTTP_X_REQUESTED_WITH'] === 'XMLHttpRequest') {
    ...
    while ($row = mysqli_fetch_assoc($query)) {
        ...
        $data[] = array(
            ...
            'aksi' => '<a href="javascript:void(0)" id="btn-detail" class="btn btn-sm btn-outline-info btn-sm mr-2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Detail" data-kode="' . $row['kode_transaksi'] . '" data-id="' . $row['id'] . '"><i class="fas fa-eye"></i></a>' 
