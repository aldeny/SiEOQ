...
if(isset($_POST['kode'])) {
    ...
    $query = mysqli_prepare($conn, "SELECT tp.id, tp.harga, tp.stock_in, tp.kode_transaksi, tp.keterangan, tp.tanggal, tp.total_harga, u.nama, s.nama_satuan, sup.kode_sup, sup.nama_sup, p.nama_obat
