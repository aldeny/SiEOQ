...
$validate = mysqli_query(
    $conn, "SELECT COUNT(*) AS jumlah_kategori FROM kategori WHERE nama_kategori = '$nm_kategori'"
);
...
if ($check['jumlah_kategori'] > 0) {
    ...
    $insert = mysqli_query($conn, "INSERT INTO kategori (nama_kategori, keterangan) VALUES ('$nama_kategori', '$keterangan')");
