                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                <table class="table table-bordered" id="tblSupplier" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Kode Supplier</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="modalSuppLabel"></h5>
                    <button class="close text-white" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="formSupplier">
                        <div class="form-group">
                            ...
                            <label for="kd_supplier" class="form-label font-weight-bolder">Kode Supplier</label>
                            <input type="text" name="kd_supplier" id="kd_supplier" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label for="nama_supplier" class="form-label font-weight-bolder">Nama Supplier</label>
                            <input type="text" name="nama_supplier" id="nama_supplier" class="form-control"
                                placeholder="Nama Supplier">
                        </div>
                        <div class="form-group">
                            <label for="no_hp" class="form-label font-weight-bolder">No. Handphone</label>
                            <input type="text" name="no_hp" id="no_hp" class="form-control" placeholder="No. Handphone">
                        </div>
                        <div class="form-group">
                            <label for="nama_supplier" class="form-label font-weight-bolder">Alamat Supplier</label>
        ...
        $(document).on('click', '#btn-edit', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#modalSuppLabel').text('Edit Buyer Supplier');
                    $('#modalSupp').modal('show');
