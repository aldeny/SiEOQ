...
<html lang="en">
    <head>
        ...
        <title>edit-obat - apt yurikha farma</title>
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="form-floating mb-3">
                                                ...
                                                <label for="inputText">KD-Obat</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputnumber" type="text" pattern="0-9" placeholder="Rp.000.00"/>
                                            ...
                                            <a class="btn btn-xs btn-warning btn-sm" href="obat.php">Tambah</a>
                                            <a class="btn btn-xs btn-dark btn-sm" href="obat.php">Cancel</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
