...
<html lang="en">
    <head>
        ...
        <title>Pengguna - apt yurikha farma</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">APT. Yurikha Farma</a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="transaksi-pembelian.html">
                            ...
                            <a class="nav-link" href="transaksi-penjualan.html">
                            ...
                            <div class="collapse" id="collapseLaporan" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav" id="sidenavAccordionLaporan">
                                    ...
                                    <a class="nav-link" href="laporan pembelian.html">
                                        Laporan Pembelian
                                    </a>
                                    <a class="nav-link" href="laporan penjualan.html">
                                        Laporan Penjualan
                                    </a>
                                    <a class="nav-link" href="eoq.html">
