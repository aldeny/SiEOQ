...
<html lang="en">
    <head>
        ...
        <title>edit - transaksi penjualan - apt yurikha farma</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h6 class="mt-4">Transaksi Penjualan Obat APT. Yurikha Farma</h6>
                                        ...
                                        <div class="form group">
                                            <table class="table table-borderless table-earning">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a class="btn btn-xs btn-warning btn-sm" href="transaksi-penjualan.php">Tambah</a>
                                                            <a class="btn btn-xs btn-dark btn-sm" href="transaksi-penjualan.php">Cancel</a>
                                                        </td>
                                                    </tr>
                                                </tbody>  
                                            </table>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                           ...
                                           <tr>
                                                ...
                                                <td><?php echo $item['nama_penginput'] ?></td>
                                                ...
                                                <td> 
                                                    <a class="btn btn-xs btn-warning btn-sm" href="edit-transaksi penjualan.php">Edit</a>
                                                    <a class="btn btn-xs btn-dark btn-sm" href="transaksi-penjualan.php">Hapus</a>
                                                </td>
                                           </tr>
