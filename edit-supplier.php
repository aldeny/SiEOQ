...
<html lang="en">
    <head>
        ...
        <title>edit-supplier - apt yurikha farma</title>
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputText" type="text" placeholder="SUP-001" />
                                                <label for="inputText">KD-Supplier</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputText" type="text" placeholder="nameexample" />
                                                <label for="inputText">Nama Supplier</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputText" type="text" placeholder="nameexample" />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputText" type="text" pattern="0-9" placeholder="nameexample" />
                                                <label for="inputText">No Hp</label>
                                            </div>
                                            <a class="btn btn-xs btn-warning btn-sm" href="supplier.php">Tambah</a>
                                            <a class="btn btn-xs btn-dark btn-sm" href="supplier.php">Cancel</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                           ...
                                           <tr>
                                                ...
                                                <td> 
                                                    <a class="btn btn-xs btn-warning btn-sm" href="edit-supplier.php">Edit</a>
                                                    <a class="btn btn-xs btn-dark btn-sm" href="supplier.php">Hapus</a>
                                                </td>
                                           </tr>
