...
<html lang="en">
    <head>
        ...
        <title>edit-user - apt yurikha farma</title>
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputText" type="email" placeholder="nameexample" />
                                            ...
                                            <a class="btn btn-xs btn-warning btn-sm" href="#">Tambah</a>
                                            <a class="btn btn-xs btn-dark btn-sm" href="#">Cancel</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                           ...
                                           <tr>
                                                ...
                                                <td> 
                                                    <a class="btn btn-xs btn-warning btn-sm" href="#">Edit</a>
