...
<html lang="en">
    <head>
        ...
        <title>edit - transaksi pembelian- apt yurikha farma</title>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                           ...
                                           <tr>
                                                ...
                                                <td><?php echo $item['jumlah_masuk'] ?></td>
                                                <td><?php echo $item['supplier'] ?></td>
                                                <td><?php echo $item['keterangan'] ?></td>
                                                <td> 
                                                    <a class="btn btn-xs btn-warning btn-sm" href="transaksi pembelian.php">Edit</a>
