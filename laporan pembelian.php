...
<html lang="en">
    <head>
        ...
        <title>laporan pembelian - apt yurikha farma</title>
                                ...
                                <div class="form group">
                                    <table class="table table-borderless table-earning">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <a class="btn btn-xs btn-primary btn-sm" href="#">Search</a>
                                                    <a class="btn btn-xs btn-warning btn-sm" href="#">Reset</a>
                                                </td>
                                            </tr>   
                                        </tbody>
                                    </table>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>KD Transaksi Pembelian</th>
                                            <th>Tgl Transaksi Pembelian</th>
                                            <th>Keterangan</th>
                                            <th>Input Oleh</th>
                                            <th>Jumlah</th>
                                        </tr>
