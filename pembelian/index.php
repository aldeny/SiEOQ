                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <table id="tbl_pembelian" class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>KD Obat</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-xs btn-warning btn-sm"
                                                href="edit- transaksi pembelian.php">Edit</a>
                                            <a class="btn btn-xs btn-dark btn-sm"
                                                href="transaksi-pembelian.php">Hapus</a>
                                        </td>
                                    </tr>
                                    <!-- End Query php -->
